...
4. 줄글 형식(마크다운 없이)으로 작성하세요.
5. 작성 분량은 300~500자 이내로 하세요.
''';

    final userPrompt = "다음은 오늘 사용자의 대화 내용입니다:\n$transcript";
  ...
  // 생성된 일기 Firebase에 저장
  static Future<void> saveDiaryToFirebase(String content, String dateId) async {
